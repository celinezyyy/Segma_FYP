...
import { assets } from '../assets/assets'; // Make sure you have a feedback icon here
...
const Feedback = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(`${backendUrl}/api/feedback/submit`, {
      ...
      if (res.data.success) {
        ...
        navigate('/'); // Redirect after submit (adjust as needed)
      } else {
  ...
  return (
    <div>
      ...
      <div className="flex min-h-screen">
        <UserSidebar />
        <main
          className="flex-grow px-4 md:px-8 pt-20 min-h-[calc(100vh-5rem)] flex flex-col items-center justify-center"
        >
          {/* Title */}
