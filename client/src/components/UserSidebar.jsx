            ...
            <li>
              ...
              {isOpen && (
                <ul className={`${segOpen ? 'block' : 'hidden'} py-2 space-y-2 pl-11`}>
                  <li><a href="#" className="block p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-700">Dataset Selection</a></li>
                  <li><a href="#" className="block p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-700">Mapping Result</a></li>
                  <li><a href="#" className="block p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-700">Segmentation Result</a></li>
                </ul>
              )}
            </li>
